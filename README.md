...
📝 Explore AI-generated documentation on [DeepWiki](https://deepwiki.com/miurla/aitbondie)
...
```bash
git clone git@github.com:[YOUR_GITHUB_ACCOUNT]/aitbondie.git
```
...
Host your own live version of AitBondie with Vercel, Cloudflare Pages, or Docker.

### Vercel

[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fmiurla%2Faitbondie&env=OPENAI_API_KEY,TAVILY_API_KEY,UPSTASH_REDIS_REST_URL,UPSTASH_REDIS_REST_TOKEN)
...
```bash
docker pull ghcr.io/miurla/aitbondie:latest
```
...
services:
  aitbondie:
    image: ghcr.io/miurla/aitbondie:latest
    env_file: .env.local
    ports:
      - '3000:3000'
    volumes:
...
If you want to use AitBondie as a search engine in your browser, follow these steps:
...
5. Fill in the fields as follows:
  - **Search engine**: AitBondie
  - **Shortcut**: aitbondie
  - **URL with %s in place of query**: `https://aitbondie.ai/search?q=%s`
6. Click "Add" to save the new search engine.
7. Find "AitBondie" in the list of site search, click on the three dots next to it, and select "Make default".

This will allow you to use AitBondie as your default search engine in the browser.
...
We welcome contributions to AitBondie! Whether it's bug reports, feature requests, or pull requests, all contributions are appreciated.
